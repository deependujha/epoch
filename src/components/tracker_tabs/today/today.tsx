...
import { CategoryMap, DEFAULT_CATEGORIES, Expense } from "@/constants/types";
import {
    saveExpense,
    updateExpense,
    deleteExpense,
} from "@/utils/api_helper_code";
    ...
    const saveOrUpdateExpense = async () => {
        ...
        if (editingId) {
            ...
            updateExpense(updated.id, updated)
                .then(() => {
                    original_data = original_data.map((e) =>
